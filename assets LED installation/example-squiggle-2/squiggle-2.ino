...
// ColorWavesWithPalettes. Animated shifting color waves, with several cross-fading color palettes. Color palettes converted for FastLED using "PaletteKnife" v1: http://fastled.io/tools/paletteknife/
